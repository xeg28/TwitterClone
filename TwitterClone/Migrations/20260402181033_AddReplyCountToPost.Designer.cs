...
namespace TwitterClone.Migrations
{
    ...
    [Migration("20260402181033_AddReplyCountToPost")]
    partial class AddReplyCountToPost
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TwitterClone.Models.PostModels.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TwitterClone.Models.PostModels.PostLike", b =>
                {
            ...
            modelBuilder.Entity("TwitterClone.Models.PostModels.Post", b =>
                {
                    ...
                    b.HasOne("TwitterClone.Models.PostModels.Post", "Repost")
                        .WithMany()
            ...
            modelBuilder.Entity("TwitterClone.Models.PostModels.PostLike", b =>
                {
                    b.HasOne("TwitterClone.Models.PostModels.Post", "Post")
                        .WithMany()
